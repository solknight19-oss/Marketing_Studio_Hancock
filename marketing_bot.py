...
QUERIES = [
    ...
    "property claims cycle time carrier",
    "insurance claims vendor consolidation",
    "claims operational efficiency insurance carrier",
    "insurance loss adjustment expense pressure",
    "carrier claims process improvement",
